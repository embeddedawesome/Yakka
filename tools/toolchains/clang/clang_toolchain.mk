...
TOOLCHAIN_LOCATION := c:/silabs/apps/llvm/bin/
#$(CURDIR)/$(HOST_OS)
else
TOOLCHAIN_LOCATION :=
endif
...
c_COMPILER   := "$(TOOLCHAIN_LOCATION)clang$(HOST_EXECUTABLE_SUFFIX)" 
cpp_COMPILER := "$(TOOLCHAIN_LOCATION)clang++$(HOST_EXECUTABLE_SUFFIX)" 
s_COMPILER   :=  $(c_COMPILER)
#ARCHIVER     := "$(TOOLCHAIN_LOCATION)ar$(HOST_EXECUTABLE_SUFFIX)"

ANALYZER     := "$(TOOLCHAIN_LOCATION)clang-tidy$(HOST_EXECUTABLE_SUFFIX)"

LLVM_LINK := "$(TOOLCHAIN_LOCATION)lld$(HOST_EXECUTABLE_SUFFIX)"
LLVM_OPT  := "$(TOOLCHAIN_LOCATION)opt$(HOST_EXECUTABLE_SUFFIX)"
